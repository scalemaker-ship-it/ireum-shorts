...
| `PRD.md` | **v3 포맷**(35~45초·7 SCENE·후킹 설계) — 단일 출처 |
| `PRD_v2.md` | v2 규칙 전문 — 검증·초상·오디오 운영 규칙은 v3에도 유효 |
...
v3 회차는 아래 두 벌이 **추가로** 필요합니다(둘 다 무료 배포, 상업 이용 가능).

| 파일 | 출처 |
|---|---|
| `BMEULJIRO.ttf` | 배달의민족 을지로체 — https://www.woowahan.com/fonts (타이틀·강조) |
| `BMHANNA.ttf` | 배달의민족 한나체 Pro — 위와 같음 (자막 본문) |
| `NotoSansKR-var.ttf` | Google Fonts — Noto Sans KR (보조) |
...
## 한 편 만들기 (v3 — 2026-09-25 확정)

**v3 회차는 `PRD.md` §0의 차례를 따른다.** 아래는 1~20화(v2) 방식이다.
...
`PRD_v2.md` 3항(검증 규칙, v3 `PRD.md` §26에 요약)만은 같이 가져가시길 권합니다.
